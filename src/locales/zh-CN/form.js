export default {
  ...
  'form.full_name.placeholder': '全名',
  'form.username.placeholder': '用户名',
  'form.birthday.placeholder': '生日',
  'form.gender.placeholder': '性别',
  'form.education.placeholder': '教育经历',
  'form.job.placeholder': '工作',
  'form.iOT_familiar.placeholder': '物联网开发经验',
  'form.embeded_familiar.placeholder': '嵌入式开发经验',
  'form.lan_familiar.placeholder': 'C/C++ 开发经验',
};
