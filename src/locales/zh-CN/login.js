export default {
  ...
  'validation.full_name.required': '请输入您的全名！',
  'validation.username.required': '请输入您的用户名!',
  'validation.birthday.required': '请输入您的生日!',
  'validation.gender.required': '请输入您的性别!',
  'validation.education.required': '请输入您的教育经历!',
  'validation.job.required': '请输入您的工作!',
  'validation.iOT_familiar.required': '请选择您的物联网开发经验!',
  'validation.embeded_familiar.required': '请选择您的嵌入式开发经验!',
  'validation.lan_familiar.required': '请选择您的C/C++开发经验!',
};
